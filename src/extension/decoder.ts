...
export class Pico8Decoder {
    public static async decode(pngPath: string): Promise<string> {
    ...
    private static decompressLegacy(ram: Uint8Array, offset: number): string {
        let out = "";
        let inPos = offset;
        const maxPos = 0x8000;
    ...
    private static readRaw(ram: Uint8Array, offset: number): string {
