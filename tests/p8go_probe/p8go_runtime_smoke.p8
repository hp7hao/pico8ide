...
function _init()
 p8go.ipc_send("music","play")
 printh("runtime_packet:"..peek(0x5f80)..","..peek(0x5f81)..","..peek(0x5f82)..","..peek(0x5f83)..","..peek(0x5f84)..","..peek(0x5f85)..","..peek(0x5f86)..","..peek(0x5f87)..","..peek(0x5f88)..","..peek(0x5f89)..","..peek(0x5f9f))
 extcmd("shutdown")
end
